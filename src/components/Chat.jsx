...
// const Chat = () => {
//   const { currentColor, setChatClose } = useStateContext();
...
//           <button type="button" className= "dark:text-gray-20  text-xs rounded p-1 px-2 bg-orange">
//             5 New
//           </button>
//         </div>
//         {/* <Button
